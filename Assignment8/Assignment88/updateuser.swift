...
for n in one.time
                    {               if (c1.time==n)
                            ...
                            else
                        {
                            ...
                            print(one.seat_c[0].course_name)
                            c1.seat+=c1.seat
                        let alertController = UIAlertController(title: "Alert", message: "You already register it!", preferredStyle: UIAlertController.Style.alert)
                        let okAction = UIAlertAction(title: "OK", style: UIAlertAction.Style.default) {
                            (result : UIAlertAction) -> Void in
                         print("OK")
                        }
...
let alertController = UIAlertController(title: "Alert", message: "You are already in the waitlist!", preferredStyle: UIAlertController.Style.alert)
                     let okAction = UIAlertAction(title: "OK", style: UIAlertAction.Style.default) {
                         (result : UIAlertAction) -> Void in
                      print("OK")
                     }
