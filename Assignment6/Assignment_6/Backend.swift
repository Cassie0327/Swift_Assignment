...
func begin()
{
    let event1:Event=Event(Id:"001",Name:"Football game",Description:"This is football game",Start_Date:"2019-10-20",End_Date:"2020-1-2",Address: Address.init(Street: "360 Huntington ave", City: "Boston", State: "MA"))
    ...
    let event3:Event=Event(Id:"003",Name:"Eating",Description:"This is eating match",Start_Date:"2019-5-20",End_Date:"2019-10-2",Address:Address.init(Street:"150 Rivers Edge" , City: "Boston", State: "MA"))
    ...
    let user2:User=User(Name:"Mark",Id:"002",Phone:"45423823",Email:"Mark@163.com",Interests:["football","running"],Skills:["Running"],Subsciption:[event1],Address:Address.init(Street:"100 Rivers Edge" , City: "Boston", State: "MA"))
